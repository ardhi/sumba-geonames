...
async function maintenance ({ type = 'modifications', headers, converterFn, date } = {}) {
  const { fs, print, importPkg, dayjs, generateId, spinner, startPlugin, getConfig } = this.app.bajo
  ...
  const { getInfo, recordFindOne, recordRemove, recordUpdate, recordCreate } = this.app.dobo
